...
var Calendar = function (_Component) {
  ...
  function Calendar(props) {
    ...
    _this.onScrollEnd = (0, _utils.debounce)(function () {
    ...
    _this.updateTodayHelperPosition = function (scrollSpeed) {
      ...
      if (!_this._todayOffset) {
        ...
        Math.ceil((today.getDate() - 7 + (0, _get_day2.default)((0, _start_of_month2.default)(today))) / 7) * rowHeight // offset of "today" within its month
        ;
      }

      if (scrollTop >= _this._todayOffset + rowHeight * (todayHelperRowOffset + 1)) {
        if (showToday !== _Today.DIRECTION_UP) newState = _Today.DIRECTION_UP; //today is above the fold
      } else if (scrollTop + height <= _this._todayOffset + rowHeight - rowHeight * (todayHelperRowOffset + 1)) {
        if (showToday !== _Today.DIRECTION_DOWN) newState = _Today.DIRECTION_DOWN; //today is below the fold
  ...
  Calendar.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_Weekdays2.default, { weekdays: locale.weekdays, weekStartsOn: locale.weekStartsOn, theme: theme }),
        _react2.default.createElement(
          'div',
...
process.env.NODE_ENV !== "production" ? Calendar.propTypes = {
  ...
  DayComponent: _react.PropTypes.func,
  disabledDates: _react.PropTypes.arrayOf(_react.PropTypes.instanceOf(Date)),
  disabledDays: _react.PropTypes.arrayOf(_react.PropTypes.number),
  display: _react.PropTypes.oneOf(['years', 'days']),
  displayOptions: _react.PropTypes.shape({
    ...
    showMonthsForYears: _react.PropTypes.bool,
  ...
  locale: _react.PropTypes.shape({
    blank: _react.PropTypes.string,
    headerFormat: _react.PropTypes.string,
    todayLabel: _react.PropTypes.shape({
      long: _react.PropTypes.string,
      short: _react.PropTypes.string
    }),
    weekdays: _react.PropTypes.arrayOf(_react.PropTypes.string),
    weekStartsOn: _react.PropTypes.oneOf([0, 1, 2, 3, 4, 5, 6])
  }),
  ...
  theme: _react.PropTypes.shape({
    floatingNav: _react.PropTypes.shape({
      background: _react.PropTypes.string,
      chevron: _react.PropTypes.string,
      color: _react.PropTypes.string
    }),
    headerColor: _react.PropTypes.string,
    selectionColor: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.func]),
    textColor: _react.PropTypes.shape({
      active: _react.PropTypes.string,
      default: _react.PropTypes.string
    }),
    todayColor: _react.PropTypes.string,
    weekdayColor: _react.PropTypes.string
  }),
  width: _react.PropTypes.number,
  YearsComponent: _react.PropTypes.func
} : void 0;
;