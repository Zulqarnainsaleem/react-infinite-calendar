...
function getWeekOffSet(yearStart, date, weekStartsOn) {
  var yearStartDate = typeof yearStart === 'number' ? new Date(yearStart, 0, 1) // 1st Jan of the Year
  : yearStart;
  var minStartDate = (0, _moment2.default)(yearStart).startOf('month');
  var selectStartDate = (0, _moment2.default)(date).startOf('month');
  var rows = 0;
  for (var i = minStartDate; i <= selectStartDate; i = (0, _moment2.default)(i).add(1, 'months')) {
    var daysinMonth = (0, _moment2.default)(i).daysInMonth();
    var startDay = (0, _moment2.default)(i).day();
    var rowCount = 6;
