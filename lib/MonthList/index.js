...
var _List2 = require('react-virtualized/dist\\commonjs\\List/List');
...
var _overscanIndicesGetter = require('./overscanIndicesGetter');

var _overscanIndicesGetter2 = _interopRequireDefault(_overscanIndicesGetter);
...
var MonthList = function (_Component) {
  ...
  function MonthList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.cache = {}, _this.state = {}, _this.memoize = function (param) {
      ...
      if (!_this.monthHeights[index]) {
        ...
        var weeks = (0, _utils.getWeeksInMonth)(month, year, weekStartsOn);
      ...
      var index = (0, _difference_in_months2.default)(min, date);
      ...
      var weeks = (0, _utils.getWeek)(min.getFullYear(), (0, _parse2.default)(date), weekStartsOn);
  ...
  MonthList.prototype.render = function render() {
    ...
    return _react2.default.createElement(_List3.default, {
      ref: 'List',
      width: width,
      height: height,
      ...
      overscanIndicesGetter: _overscanIndicesGetter2.default
    });
  };
